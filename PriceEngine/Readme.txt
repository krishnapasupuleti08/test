Attached 2 jsons in the project file to change the inputs.

database.json : file is to create part's price, which already has some test data that can be modified.

user-input.json : To give the user input.
